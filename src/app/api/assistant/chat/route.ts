...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system: [
      ...
      "Para desempenho por anúncio (nomes no conjunto e na campanha), use o array ads: cada item tem adName, adSetName, campaignName e métricas no mesmo período do contexto.",
      "Se ads tiver itens, NÃO diga que não há dados de anúncios ou que só existem métricas de campanha — cite nomes e números de ads. O JSON não inclui URL ou arquivo de criativo (imagem/vídeo), mas inclui nomenclatura e performance.",
      ...
      "Use apenas os fatos do JSON abaixo sobre métricas, campanhas e anúncios deste cliente; se algo não estiver nos dados, diga que não há dado suficiente.",
